...
class Verifikasi extends CI_Controller
{
	...
	public function butuhKelengkapanData(){
	...
	public function butuhSurveyLapangan(){
	...
	public function generateHasilVerifikasiKANWIL(){
		...
		$dataArray = array(
						"jabatan_pemohon" => "Sekretaris Daerah",
						"nama_satker" => "Budi",
						"nomor_surat_permohonan" => "01/Kota/2019",
						"tanggal_surat_permohonan" => "01/01/2019",
						"sesuai_catatan_khusus" => "Ini Catatan khusus",
						"plh_plt" => "PLT",
						"nama_kepala_seksi" => "Budi Angkasa",
						"nip_kepala_seksi" => "199554212 215 2 001",
						"nama_verifikator" => "Satria Planet",
						"nip_verifikator" => "199554212 215 2 002"
						);
	...
	public function generateKMKKPKNL()
	{
		...
		//set seuai nama variable yang diganti
		$dataArray=array(
					"kode_kpknl" => "kode12345678",
					"nama_kl" => "Direktorat Kekayaan",
					"tahun_terbit" => "2019",
					"kementerian_lembaga" => "Direktorat Jendral Kekayaan Negara",
					"kementerian_pemohon" => "Direktorat Jendral Kekayaan Negara",
					"jabatan_pemohon" => "Ketua Umum",
					"nama_satker" => "Budi Angkasa",
					"nomor_surat_permohonan" => "01/INS-KOTA/VIII/2019",
					"tanggal_surat_permohonan" => "19/07/2019",
					"perihal_surat_permohonan" => "Permohonan Pendanaan",
					"jenis_bmn" => "ATK",
					"total_nilai_bmn" => "50000",
					"huruf_total_nilai_bmn" =>  $this->common->terbilang(13005400),
					"nama_tembusan1" => "Kepala Daerah",
					"nama_tembusan2" => "Kepala Kanwi",
					"nama_tembusan3" => "Ketua Umum",
					"nama_KPKNL" => "Sapto Arianto",
					"tanggal_cetak" => "30/08/2019",
					"plh_plt" => "PLT",
					"nama_kepala_kantor" => "Made Ariandana"
		...
		$templateProcessor->setValue('total_nilai_bmn', $dataArray["total_nilai_bmn"]);
		$templateProcessor->setValue('huruf_total_nilai_bmn', $dataArray["huruf_total_nilai_bmn"]);
		$templateProcessor->setValue('nama_tembusan1', $dataArray["nama_tembusan1"]);
		$templateProcessor->setValue('nama_tembusan2', $dataArray["nama_tembusan2"]);
		$templateProcessor->setValue('nama_tembusan3', $dataArray["nama_tembusan3"]);
		$templateProcessor->setValue('nama_KPKNL', $dataArray["nama_KPKNL"]);
		$templateProcessor->setValue('tanggal_cetak', $dataArray["tanggal_cetak"]);
		$templateProcessor->setValue('plh_plt', $dataArray["plh_plt"]);
		$templateProcessor->setValue('nama_kepala_kantor', $dataArray["nama_kepala_kantor"]);
     	...
     	$templateProcessor->saveAs($targetSaveFile.$file);
    ...
    {	
    	if(true){
            ...
            if ($this->verifikasi_model->update($id, $data)) {
                $result['error'] = false;
                $result['msg']   = 'Verifikasi Updated Successfully';
